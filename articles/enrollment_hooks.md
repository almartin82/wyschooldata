# 10 Insights from Wyoming School Enrollment Data
...
#> [1] ggplot2_4.0.1      tidyr_1.3.2        dplyr_1.1.4        wyschooldata_0.1.0
#> 
#> loaded via a namespace (and not attached):
#>  [1] gtable_0.3.6       jsonlite_2.0.0     qpdf_1.4.1         compiler_4.5.2    
#>  [5] pdftools_3.6.0     Rcpp_1.1.1         tidyselect_1.2.1   xml2_1.5.2        
