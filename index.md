...
|--------------------|-----------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|
| **Enrollment**     | 2000-2007 | [`fetch_enr()`](https://almartin82.github.io/wyschooldata/reference/fetch_enr.md) / [`fetch_enr_multi()`](https://almartin82.github.io/wyschooldata/reference/fetch_enr_multi.md) | State, district, school. Total enrollment only (PDF era) |
...
### 5. Cheyenne and Casper alone account for more than 1 in 4 Wyoming students
...
[(source)](https://almartin82.github.io/wyschooldata/articles/enrollment_hooks.html#cheyenne-and-casper-alone-account-for-more-than-1-in-4-wyoming-students)
