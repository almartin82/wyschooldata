...
data_available <- tryCatch({
  test <- wyschooldata::fetch_enr(2024, use_cache = TRUE)
  nrow(test) > 0
...
- **Economic disparities**: Reservation and rural districts face highest poverty rates
- **Tiny districts**: Some districts serve fewer than 200 students across vast geography
