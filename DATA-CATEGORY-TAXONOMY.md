...
Canonical taxonomy of data types that US state Departments of Education
publish about schools. These 9 categories (Tiers 1-2) are shown in each
package’s README Data Taxonomy table.

Part of the [state schooldata
project](https://github.com/almartin82/njschooldata).
...
| \#  | Category                      | Notes                                      |
|-----|-------------------------------|--------------------------------------------|
| 1   | **Enrollment & Demographics** | Race, gender, grade level, FRL             |
| 2   | **Assessments / Test Scores** | State tests, proficiency levels, growth    |
| 3   | **Graduation Rates**          | 4-yr ACGR, extended rates, diploma types   |
| 4   | **School/District Directory** | Names, IDs, addresses, coordinates, locale |

### 1. Enrollment & Demographics

- Total headcount by school, district, state
- Enrollment by grade level (PK through 12)
- Enrollment by race/ethnicity (White, Black, Hispanic, Asian, Native
  American, Pacific Islander, Multiracial)
- Enrollment by gender
- Free and Reduced-Price Lunch (FRPL) eligibility
- English Learners / LEP counts
- Students with Disabilities / IEP counts
- Charter, magnet, virtual school enrollment
- Pre-K / early childhood enrollment

### 2. Assessments / Test Scores

- State standardized test proficiency rates (ELA, Math, Science, Social
  Studies)
...
| \#  | Category                     | Notes                                          |
|-----|------------------------------|------------------------------------------------|
| 5   | **Per-Pupil Expenditure**    | School-level spending (ESSA-mandated)          |
| 6   | **Accountability Ratings**   | A-F grades, star ratings, CSI/TSI lists        |
| 7   | **Chronic Absenteeism**      | Most common ESSA “5th indicator”               |
| 8   | **English Learner Progress** | ELP assessment, reclassification rates         |
| 9   | **Special Education**        | IDEA disability categories, placement settings |

### 5. Per-Pupil Expenditure

- Total per-pupil expenditure at school level
...
- CSI/TSI/ATSI school lists
- Component scores (achievement, growth, gap closing, graduation)
...
- Reclassification / redesignation rates
- Long-term English Learner counts
- Home language distribution

### 9. Special Education

- Students with disabilities by IDEA disability category
